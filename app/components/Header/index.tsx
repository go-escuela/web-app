          ...
          >
            <span className="relative block size-5.5 cursor-pointer">
              <span className="absolute right-0 size-full">
                ...
                ></span>
                <span
                  className={`relative left-0 top-0 my-1 block h-0.5 w-0 rounded-sm bg-black delay-150 duration-200 ease-in-out dark:bg-white ${!props.sidebarOpen && "!w-full"
                    }`}
                ></span>
                <span
              ...
              <span className="absolute right-0 size-full rotate-45">
                ...
                ></span>
                <span
                  className={`absolute left-0 top-2.5 block h-0.5 w-full rounded-sm bg-black duration-200 ease-in-out dark:bg-white ${!props.sidebarOpen && "!h-0 !delay-200"
                    }`}
                ></span>
              </span>
            </span>
